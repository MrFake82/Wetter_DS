...
char auth[] = "b8d597b0dcf24c8f85358be6c2cd8ef0"; //Büro für zu Hause
//char auth[] = "587c125d085c4825b625ce8fd3ddb72b"; //Büro Blynk Server
// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[14]; //ssid und pass welches gebucht wird
char pass[14];
String ssid1 = "Batholomew"; //ssid und pass mit Index wird gesucht
String pass1 = "Hansestadt13";
String ssid2 = "ProfiNet";
String pass2 = "$tarRag.c0m";
char host[] = "kaizim.webhop.me";
char host2[] = "kaizim.zapto.org";
bool host1Down = false;
bool host2Down = false;
char fingerprint[] = "3D 4E 6B F8 F8 C3 53 22 22 2F 9C 84 F7 E7 C0 66 00 8D 22 12"; //MD5
uint16_t port = 8083;
